    ...
    <div class="pantry pa-6">
        <v-list two-line flat>
            ...
            <v-row>
                <v-col cols="8">
                    <!-- Dropdown item -->
                    <v-select v-model="selectedItem" :items="Object.values(all_items.s_item_name)" label="Outlined style" outlined></v-select>
                </v-col>
    
                <v-col cols="4">
                    <!-- Dropdown QTY -->
                    <v-text-field v-model.number="qty" @click:append="addItem" @keyup.enter="addItem" outlined hide-details label="QTY" append-icon="mdi-plus" type="number"></v-text-field>
                </v-col>
            </v-row>
...
export default {
    ...
    methods: {
        ...
        processPantry() {
            // loop through all items to list them
